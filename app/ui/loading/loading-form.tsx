...
import {updateLoadingLog} from '@/app/lib/action'
import TruckCheckIn from '@/app/lib/models/TruckCheckIn';
import { TruckCheckInFields } from '@/app/lib/definition';


export default function LoadingLog({TruckCheckIn}: {TruckCheckIn: TruckCheckInFields}) {

  const updateTruckLogWithId = updateLoadingLog.bind(null, TruckCheckIn.truckCheckInId)
