...
import { UpdateTruckLog, DeleteTruckLog, Location } from '@/app/ui/loading/buttons';
            ...
            <tbody className="bg-white">
              {truckCheckIns?.map((truckCheckIn) => (
                ...
                >
                  ...
                  <td className="whitespace-nowrap px-3 py-3">
                    {truckCheckIn.loadingStartTime?.toLocaleString()}
                  </td>
                  <td className="whitespace-nowrap px-3 py-3">
                    {truckCheckIn.loadingEndTime?.toLocaleString()}
                  </td>
                  <td className="whitespace-nowrap px-3 py-3">
